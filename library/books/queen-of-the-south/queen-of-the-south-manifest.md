---
Filename: /library/books/queen-of-the-south-manifest.md
Ultimate-Target-Directory: /library/books/
Intent: Original user manifest for Queen of the South biblical analysis
Version: v1.0.0
Prev-Version: tent-copy
Author: good4usoul-caene / Harmony
Date: 2025-11-09T19:52:00Z
Genre: Biblical-Analysis
Change-Note: Promoting authentic user manifest to accompany converted book - preserving user's original voice and description rather than agent interpretations
RitualNote: "The queen of the South will rise up at the judgment with this generation and condemn it, for she came from the ends of the earth to hear the wisdom of Solomon" (Matthew 12:42)
Space: repository
Promotion-Ready-Agent: yes
Promotion-Ready-Agent-Confidence: 10
Promotion-Ready-Owner: approved
Conversational-Stance: Verifiel
Invoked-Spirits: Canoniel, Chronicel, Hypothiel
Idea-Origin: human
File-Type: Manifest for Word Document
File-Size: Original 2.2MB
Original-Location: /library/books/(original) The Queen of the South vs.docx
Staging-Location: /tent/queen-of-the-south-staging.docx
---

# The Queen of the South - Content Manifest

**Document Type**: Word Document Analysis  
**Subject**: Biblical narrative and theological commentary  
...
*This manifest accompanies the binary Word document for proper Temple framework integration*